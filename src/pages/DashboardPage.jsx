...
import { 
  Package, Users, TrendingUp, Leaf, Plus, Clock, MapPin, 
...
const DashboardPage = () => {
  ...
  // Fetch all donations (limit 6)
  const { donations: allDonations, loading: allLoading, error: allError } =
    useRealTimeDonations({ limit: 6 });

  // Fetch donations created by logged-in user
  const { donations: userDonations, loading: userLoading, error: userError } =
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pb-20">
      <div className="max-w-6xl mx-auto p-4 sm:p-6">
        ...
        {/* Live Stats */}
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Live Community Impact</h2>
          <LiveStats />
        </div>
        ...
        {/* My Recent Donations (Only donors) */}
        {user?.userType === 'donor' && (
          <div className="mb-8">
